...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Пункты списков';
...
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Списки пользователей';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `lists` VALUES (0,0,'ALL','/images/lists/noListImage.jpg','/images/lists/preview/noListPreview.jpg');
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Теги';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tags` VALUES (4,'#Bach'),(6,'#classic'),(5,'#DeepPurple'),(8,'#new Tag'),(7,'#rock'),(3,'#Искусство'),(9,'#Моя волна'),(1,'#Музыка'),(2,'#Наука');
...
INSERT INTO `users` VALUES (0,'ALL','no_email@fiction.all','no',NULL,'2022-08-23 06:59:45',NULL,'/images/users/noUserImage.jpg','/images/users/preview/noUserPreview.jpg');
...
-- Dump completed on 2022-09-06 21:11:09
